...
(function(mod) {
  ...
  function buildLineContent(cm, lineView) {
    ...
    var clonedChild = builder.pre.firstChild;
    builder.pre.appendChild(codeElement);
    builder.pre.removeChild(builder.pre.firstChild);
    builder.pre.firstChild.appendChild(clonedChild);
    lineView.measure = {};
